...
# 2. In class Graph, define _init_() method to initialise instance object variables
# vertex_count and a dict adj_list where key is vertex number and value is a list of adjacent vertices.
